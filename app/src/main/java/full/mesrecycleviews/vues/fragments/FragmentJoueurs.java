...
import full.mesrecycleviews.donnees.JoueurDAO;
import full.mesrecycleviews.modeles.GroupeJoueur;
import full.mesrecycleviews.modeles.Joueur;
import full.mesrecycleviews.vues.adapteurs.ListContentAdapter;
...
public class FragmentJoueurs extends Fragment {
    ...
    private void initRecyclerView() {
        ...
        for (GroupeJoueur g: listeGroupes){
            ...
            Log.e("Nbr joueur grp:", String.valueOf(g.getJoueurs().size()));
        }
